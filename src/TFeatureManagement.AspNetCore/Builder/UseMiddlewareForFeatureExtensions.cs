...
namespace TFeatureManagement.AspNetCore.Builder
{
    public static class UseMiddlewareForFeatureExtensions
    {
        ...
        /// <param name="feature">
        /// The feature that needs to be enabled to add the middleware type in the application's request pipeline.
        /// </param>
            ...
            where TFeature : Enum
        {
            ...
            // Create and configure the branch builder right away; otherwise, we would end up running our branch after
            // all the components that were subsequently added to the main builder.
