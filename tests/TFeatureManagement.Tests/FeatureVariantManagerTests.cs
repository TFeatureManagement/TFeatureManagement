...
[TestClass]
public class FeatureVariantManagerTests
{
    private FeatureVariantManager<Feature> _underTest;

    private IVariantFeatureManager _baseFeatureVariantManager;
    ...
    public void Setup()
    {
        _baseFeatureVariantManager = Substitute.For<IVariantFeatureManager>();
        ...
        _underTest = new FeatureVariantManager<Feature>(
            _baseFeatureVariantManager,
    ...
    public async Task GetVariantAsync_CallsBaseGetVariantAsyncCorrectly_CalledWithoutTargetingContext()
    {
        ...
        _baseFeatureVariantManager.GetVariantAsync(Arg.Any<string>(), Arg.Any<CancellationToken>()).Returns(default(Variant));
...
#pragma warning disable CA2012 // Use ValueTasks correctly
        _baseFeatureVariantManager.Received()
            .GetVariantAsync(
                expectedFeatureName,
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
    ...
    public async Task GetVariantAsync_ReturnsBaseGetVariantAsyncResult_CalledWithoutTargetingContextAndBaseResultIsNotNull()
    {
        ...
        _baseFeatureVariantManager.GetVariantAsync(Arg.Any<string>(), Arg.Any<CancellationToken>()).Returns(expectedBaseFeatureVariant);
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
    ...
    public async Task GetVariantAsync_ReturnsNullResult_CalledWithTargetingContextAndBaseResultIsNull()
    {
        ...
        var expectedContext = Substitute.For<ITargetingContext>();
        var expectedCancellationToken = new CancellationToken(true);
        _baseFeatureVariantManager.GetVariantAsync(Arg.Any<string>(), Arg.Any<Microsoft.FeatureManagement.FeatureFilters.ITargetingContext>(), Arg.Any<CancellationToken>()).Returns(default(Variant));
    ...
    public async Task GetVariantAsync_ReturnsBaseGetVariantAsyncResult_CalledWithTargetingContextAndBaseResultIsNotNull()
    {
        ...
        _baseFeatureVariantManager.GetVariantAsync(Arg.Any<string>(), Arg.Any<Microsoft.FeatureManagement.FeatureFilters.ITargetingContext>(), Arg.Any<CancellationToken>()).Returns(expectedBaseFeatureVariant);
