...
namespace TFeatureManagement.AspNetCore.Mvc.TagHelpers
{
        ...
        where TFeature : Enum
    {
        ...
        /// <summary>
        /// Controls whether 'All' or 'Any' feature in a list of features should be enabled to render the content within
        /// the feature tag.
        /// </summary>
        public RequirementType Requirement { get; set; } = RequirementType.All;

        /// <summary>
        /// Negates the evaluation for whether or not a feature tag should display content. This is used to display
        /// alternate content when a feature or set of features are disabled.
        /// </summary>
